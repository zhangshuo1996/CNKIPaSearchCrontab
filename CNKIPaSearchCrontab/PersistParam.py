...
class PersistParam(object):
    ...
    def __init__(self, basedir, school):
        self.school = school
        self.basedir = basedir
        self.filename = os.path.join(self.basedir, 'crontab_files', 'checkpoint')
        self.cur_page = 1
    ...
    def _load_from_dir(self):
        ...
        path = os.path.join(self.basedir, 'crontab_files', 'pending')

        # --------
        file_path = os.path.join(path, self.school + '.json')
